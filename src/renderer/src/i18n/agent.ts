...
export const agentZh = {
  ...
  'agent.interaction.planSummary': '计划摘要',
  'agent.interaction.savePlan': '保存计划修改',
  'agent.interaction.planSaved': '计划已保存',
  'agent.interaction.planVersion': '版本 {version}',
  'agent.interaction.expandPlan': '展开计划',
  'agent.interaction.collapsePlan': '收起计划',
  'agent.plan.progress': ({ completed, total }: Record<string, string | number>) => `已完成 ${completed}/${total}`,
  'agent.plan.lifecycle.draft': '草稿',
  'agent.plan.lifecycle.review': '待审批',
  'agent.plan.lifecycle.approved': '已批准',
  'agent.plan.lifecycle.executing': '执行中',
  'agent.plan.lifecycle.completed': '已完成',
  'agent.plan.lifecycle.failed': '失败',
  'agent.plan.lifecycle.superseded': '已替代',
  'agent.plan.step.pending': '待处理',
  'agent.plan.step.in_progress': '进行中',
  'agent.plan.step.completed': '已完成',
  'agent.plan.retry': '重试执行',
...
export const agentEn: Record<keyof typeof agentZh, string> = {
  ...
  'agent.interaction.planSummary': 'Plan summary',
  'agent.interaction.savePlan': 'Save plan changes',
  'agent.interaction.planSaved': 'Plan saved',
  'agent.interaction.planVersion': 'Version {version}',
  'agent.interaction.expandPlan': 'Expand plan',
  'agent.interaction.collapsePlan': 'Collapse plan',
  'agent.plan.progress': '{completed}/{total} complete',
  'agent.plan.lifecycle.draft': 'Draft',
  'agent.plan.lifecycle.review': 'Needs review',
  'agent.plan.lifecycle.approved': 'Approved',
  'agent.plan.lifecycle.executing': 'Executing',
  'agent.plan.lifecycle.completed': 'Completed',
  'agent.plan.lifecycle.failed': 'Failed',
  'agent.plan.lifecycle.superseded': 'Superseded',
  'agent.plan.step.pending': 'Pending',
  'agent.plan.step.in_progress': 'In progress',
  'agent.plan.step.completed': 'Completed',
  'agent.plan.retry': 'Retry execution',
